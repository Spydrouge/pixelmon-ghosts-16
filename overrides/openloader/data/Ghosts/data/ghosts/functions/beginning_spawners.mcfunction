...
execute at @e[type=armor_stand,tag=IslandCenter,scores={IDMath=0}] run setblock ~ ~-2 ~ minecraft:structure_block[mode=load]{metadata:"protected",mirror:"NONE",ignoreEntities:1b,powered:0b,seed:0L,rotation:"NONE",mode:"LOAD",posX:0,posY:0,posZ:0,integrity:1.0f,showair:0b,name:"ghosts:phantump_spawn",id:"minecraft:structure_block",sizeX:1,sizeY:2,sizeZ:1,showboundingbox:0}
execute at @e[type=armor_stand,tag=IslandCenter,scores={IDMath=0}] run setblock ~ ~-1 ~ redstone_block

#Create the structure block for the Shedinja
execute at @e[type=armor_stand,tag=IslandCenter,scores={IDMath=0}] run setblock ~1 ~6 ~7 minecraft:structure_block[mode=load]{metadata:"protected",mirror:"NONE",ignoreEntities:1b,powered:0b,seed:0L,rotation:"NONE",mode:"LOAD",posX:0,posY:0,posZ:0,integrity:1.0f,showair:0b,name:"ghosts:shedinja_spawn",id:"minecraft:structure_block",sizeX:1,sizeY:2,sizeZ:1,showboundingbox:0}
execute at @e[type=armor_stand,tag=IslandCenter,scores={IDMath=0}] run setblock ~1 ~7 ~7 redstone_block

title @p subtitle {"text":"Bug Pokemon are Emerging!"}
title @p title {"text":"Life Finds a Way..."}