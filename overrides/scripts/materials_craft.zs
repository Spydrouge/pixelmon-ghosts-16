...
for i in allNuggets{
	...
	{
		molt = <fluid:materialis:molten_fairy> * 16;
	}
	else
	{
	...
	//melting recipe
	<recipetype:tconstruct:melting>.addMeltingRecipe(i + "_nugget_melt", <tagmanager:items>.getTag(loc), molt, 150, 50);
...
for i in allBlocks{
	...
	{
		molt = <fluid:materialis:molten_fairy> * 296;
	}
	else
	{
	...
	//melting recipe
	<recipetype:tconstruct:melting>.addMeltingRecipe(i + "_block_melt", <tagmanager:items>.getTag(loc), molt, 150, 50);
...
for i in allGears{
	...
	{
		molt = <fluid:materialis:molten_fairy> * 576;
	}
	else
	{
	...
	//melting recipe
	<recipetype:tconstruct:melting>.addMeltingRecipe(i + "_gear_melt", <tagmanager:items>.getTag(loc), molt, 150, 50);
...
for i in allPlates{
	...
	{
		molt = <fluid:materialis:molten_fairy> * 144;
	}
	else
	{
	...
	//melting recipe
	<recipetype:tconstruct:melting>.addMeltingRecipe(i + "_plate_melt", <tagmanager:items>.getTag(loc), molt, 150, 50);
...
for i in allIngots{
	...
	//melting recipe
	<recipetype:tconstruct:melting>.addMeltingRecipe(i + "_ingot_melt", <tagmanager:items>.getTag(loc), molt, 150, 50);
